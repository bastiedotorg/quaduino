...
const int sendModAkt = 5; //Modul das sendet
const int empfModRX1 = 2; //Modul das empfängt
const int empfModRX2 = 3; //Modul das empfängt
const int empfModRX3 = 4; //Modul das empfängt
